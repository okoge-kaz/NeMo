...
NEMO_V1_CHECKPOINT_DIR=/gs/bs/tga-NII-LLM/checkpoints/hf-to-nemo/Llama-3.1-70b
NEMO_V2_CHECKPOINT_DIR=/gs/bs/tga-NII-LLM/checkpoints/hf-to-nemo/Llama-3.1-70b-nemo-v2

mkdir -p $NEMO_V2_CHECKPOINT_DIR

python scripts/checkpoint_converters/convert_nemo1_to_nemo2.py \
  --input_path $NEMO_V1_CHECKPOINT_DIR/llama-3.1-70b.nemo \
