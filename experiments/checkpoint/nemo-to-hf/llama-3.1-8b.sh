...
NEMO_CHECKPOINT_PATH=/gs/bs/tga-NII-LLM/checkpoints/hf-to-nemo/Llama-3.1-8b/llama-3.1-8b.nemo
TMP_CHECKPOINT_DIR=/gs/bs/tga-NII-LLM/checkpoints/nemo-to-hf/Llama-3.1-8b/tmp
HF_CHECKPOINT_DIR=/gs/bs/tga-NII-LLM/checkpoints/nemo-to-hf/Llama-3.1-8b/hf
